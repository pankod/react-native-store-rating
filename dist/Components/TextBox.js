...
class TextBox extends react_1.Component {
    ...
    renderTextInput() {
        return (react_1.default.createElement(react_native_1.TextInput, { accessibilityLabel: this.props.accessibilityLabel, autoCapitalize: this.props.autoCapitalize, autoFocus: this.props.autoFocus, placeholder: this.props.placeholder, autoCorrect: false, value: this.props.value, secureTextEntry: this.props.secureTextEntry, keyboardType: this.props.keyboardType, style: this.renderStyle(), underlineColorAndroid: 'transparent', onChangeText: this.onChange.bind(this), onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus, editable: !this.props.disabled, multiline: this.props.multiline, onLayout: (event) => this.setState({ textboxWidth: event.nativeEvent.layout.width }), numberOfLines: this.props.multiline ? 4 : 1, maxLength: this.props.maxLength, onSubmitEditing: this.props.onSubmitEditing, returnKeyType: this.props.returnKeyType, placeholderTextColor: this.props.placeholderTextColor }));
    }
    renderStyle() {
        return ([
